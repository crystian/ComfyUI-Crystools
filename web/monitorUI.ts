...
//   private htmlIdCrystoolsRoot = 'crystools-root';
//   private htmlClassParentElement = 'comfyui-menu-push';
//
//   constructor(
...
//   ) {
//     super();
//     this.createRootOldMenu();
//     this.createDOM();
//     console.log('MonitorUI created', this.newMenu);
//   }
//
//   override createDOM = (): void => {
//     this.createDOMOldMenu();
//     this.createDOMNewMenu();
//   };
//
//   createDOMNewMenu = (): void => {
//     this.htmlContainer = document.createElement('div');
//     this.htmlContainer.setAttribute('id', this.htmlIdCrystoolsRoot);
//
//     // the best parentElement:
//     const parentElement = document.getElementsByClassName(this.htmlClassParentElement)[0];
//     parentElement?.insertAdjacentElement('afterend', this.htmlContainer);
//
...
//       this.monitorGPUSettings[index] &&
//       this.htmlContainer.append(this.createMonitor(this.monitorGPUSettings[index]));
//       this.monitorVRAMSettings[index] &&
//       this.htmlContainer.append(this.createMonitor(this.monitorVRAMSettings[index]));
